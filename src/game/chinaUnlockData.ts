import type { BusinessId, UnlockDefinition } from "./types";

export type ChinaUnlockRow = readonly [
  name: string,
  goal: number,
...
const parseRows = (source: string): ChinaUnlockRow[] =>
  source
    .trim()
    .split("\n")
    .map((line) => {
      const [name, goal, effect] = line.split("|");
      const multiplier = Number(effect.match(/x\s*([\d.]+)/i)?.[1] ?? 1);

      return [
        name.trim(),
        Number(goal),
        /speed/i.test(effect) ? "speed" : "profit",
        multiplier,
      ];
    });

export const chinaBusinessUnlockRowsById: Partial<Record<BusinessId, ChinaUnlockRow[]>> = {
  "pandabuy-agent": parseRows(`
Pay Dirt|200|Profit x3
Dirty Deeds...|400|Profit x3
...Done Dirt Cheap|600|Profit x3
...
Optimus Grime|10000|Profit x3
That's Soil Folks|10500|Profit x3
...
Dig Douglas|16500|Profit x3
Trio Trio Trio|17000|Profit x3
Ground Type|17500|Profit x3
Daru Day Sandstorm|18000|Profit x3
...
I Can't Sand It!|25500|Profit x3
...
Tastes Like Chicken|35500|Profit x3
...
`),
  "shein-factory": parseRows(`
Deep Fried Goodness|75|Profit x3.33
...
Chicken Nougats|2275|Profit x3.33
Grease Lightning|2450|Profit x3.33
Finger Lickin Good|2625|Profit x3.33
...
Fries With That?|3325|Profit x3.33
...
Gummy Werebears|11025|Profit x3.33
...
Please Sir, Can I have Some More?|17500|Profit x3.33
`),
  wechat: parseRows(`
Men Men Men Men, Manly Men|100|Profit x5
Fun To Stay At The M.A.R.S.|200|Profit x5
Mens Room|300|Profit x5
Texas Ranger|400|Profit x5
Now You're a Man!|500|Profit Speed x2
Round House Kicks|600|Profit x6
Discovered The Wheel|700|Profit x9
It's Science|800|Profit x9
Man Overboard|900|Profit x9
Rocketman|1000|Profit Speed x5
Buy-ceps|1100|Profit x9
Testosterownd|1200|Profit x9
Five O'Clock Shadow|1300|Profit x9
It's Reigning Men!|1400|Profit x9
...
The First Rule|2200|Profit x9
And The Second Rule|2400|Profit x9
Men In Tights|2600|Profit x9
Lumberjacks Anonymous|2800|Profit x9
Flannel Suits|3000|Profit x9
Popped Collar|3200|Profit x9
Big Trucks|3400|Profit x9
An Abundance Of Chairs|3600|Profit x9
On A Boat|3800|Profit x9
...
All The Homeruns|6000|Profit x9
Touchdown!|6200|Profit x9
GOOOOAAALLL!|6400|Profit x9
Checkered Flag!|6600|Profit x9
...
Superbowl Sundays|8600|Profit x9
Hundreds of Stanley Cups|8800|Profit x9
Gladitorial Combat|9000|Profit x9
A Fart Joke|9200|Profit x9
Presidential Combat|9400|Profit x9
Knights Running Around|9600|Profit x9
The Bro-lympics|9800|Profit x9
...
`),
  "drone-swarm": parseRows(`
Oh Give Me A Home|10|Profit x2
Where The Buggles All Roam|20|Profit x2
Where The Gears...|40|Profit x2
And The Cantelope Lay|80|Profit x2
Where Seldom Is Burned|100|Profit Speed x2
With Discouraging Words|150|Profit x2
And The Skies Are Not Cloudy|200|Profit x2
At All|250|Profit x2
...
Shut Up And Take My $$$|777|Profit x77777
...
There's A Snake In My Boot|2900|Profit x5
...
Man's Pest Friend|6500|Profit x5
...
Baa Baa Buggle|7100|Profit x5
Have You Any Wool?|7200|Profit x5
No Sir No Sir|7300|Profit x5
Just Horrifying Moults|7400|Profit x5
Old McBuggle Had A Farm|7500|Profit x5
E I E I WHOA!|7600|Profit x5
On His Farm He Had Some Buggles|7700|Profit x5
With A SCREEE SCREEE Here|7800|Profit x5
And A SCREEE SCREE There|7900|Profit x5
Quite Horrifying Actually|8000|Profit x5
`),
  "tiktok-algo": parseRows(`
Unholy Cow!|25|Profit x7
What The Heck?|50|Profit x7
Heckraiser|100|Profit x7
...
Bat Out Of Heck|2750|Profit x666
...
`),
  "huawei-phone": parseRows(`
We Come In Peace|10|Profit x6
Close Encounters|50|Profit x6
...
Wubba Lubba Dub Dub|600|Profit x3
And That's The Way The News Goes|650|Profit x3
Grass Tastes Bad|700|Profit x3
AdCap 100 Years!|750|Profit x7
...
I'll Be Back-aroonie|1750|Profit x8
...
Capital-ception|7000|Profit x8
We Must Go Deeper|7150|Profit x8
Grab Your Top|7300|Profit x8
Crossed References|7450|Profit x8
BWWAAAAAAAAAAAAA!|7600|Profit x8
`),
  "robot-dog": parseRows(`
iMars|100|Profit x15
Tortoiseneck Sweaters|200|Profit x15
Reality Showoff|300|Profit x15
Mac & Me|400|Profit x15
Basket of Apples|500|Profit Speed x2
Easy Mac|700|Profit x50
Wizard of Woz|900|Profit x50
Apple Jacked|1100|Profit x50
...
`),
  deepseek: parseRows(`
Eight Legged Freaks|33|Profit x333
Man Of Steel Reference|66|Profit x333
Just Go With It|99|Profit x333
Radioactive|222|Profit x333
Spiders in Disguise|333|Profit x333
Arachnophobia|444|Profit x333
Wicky Wild Wild|555|Profit x333
Spins a Web Any Size|666|Profit x333
Element 36|777|Profit x333
Black Widower|888|Profit x333
Austrailian Exchange Program|999|Profit x333
Salutations|1111|Profit x333
Fire Won't Save You Now|2222|Profit x333
`),
};

export const chinaAllBusinessUnlockRows = parseRows(`
...
Show Them The Meaning Of Haste|2500|Profit speed of all investments x2
`);
